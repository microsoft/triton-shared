module {
  tt.func public @wrap_side_by_side_masked_loop_0d1d2e3e4e5c6e7c(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.max_divisibility = 8 : i32}, %arg3: i32 {tt.max_divisibility = 8 : i32}, %arg4: i32 {tt.max_divisibility = 8 : i32}, %arg5: i32 {tt.max_divisibility = 8 : i32}) attributes {noinline = false} {
    ...
    %12 = tt.splat %arg0 : (!tt.ptr<f32>) -> tensor<4x4x!tt.ptr<f32>>
    %13 = tt.addptr %12, %11 : tensor<4x4x!tt.ptr<f32>>, tensor<4x4xi32>
    ...
    %17 = tt.splat %arg1 : (!tt.ptr<f32>) -> tensor<4x1x!tt.ptr<f32>>
    %18 = tt.addptr %17, %16 : tensor<4x1x!tt.ptr<f32>>, tensor<4x1xi32>
    %19 = tt.expand_dims %0 {axis = 0 : i32} : (tensor<4xi32>) -> tensor<1x4xi32>
    %20 = tt.broadcast %18 : (tensor<4x1x!tt.ptr<f32>>) -> tensor<4x4x!tt.ptr<f32>>
    %21 = tt.broadcast %19 : (tensor<1x4xi32>) -> tensor<4x4xi32>
    %22 = tt.addptr %20, %21 : tensor<4x4x!tt.ptr<f32>>, tensor<4x4xi32>
    ...
    %27:2 = scf.for %arg6 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg7 = %13, %arg8 = %22) -> (tensor<4x4x!tt.ptr<f32>>, tensor<4x4x!tt.ptr<f32>>)  : i32 {
      %28 = tt.load %arg7, %24, %cst_0 {cache = 1 : i32, evict = 1 : i32, isVolatile = false} : tensor<4x4xf32>
      tt.store %arg8, %28 {cache = 1 : i32, evict = 1 : i32} : tensor<4x4xf32>
      %29 = tt.addptr %arg7, %26 : tensor<4x4x!tt.ptr<f32>>, tensor<4x4xi32>
      %30 = tt.addptr %arg8, %cst : tensor<4x4x!tt.ptr<f32>>, tensor<4x4xi32>
      scf.yield %29, %30 : tensor<4x4x!tt.ptr<f32>>, tensor<4x4x!tt.ptr<f32>>
    }
    tt.return
  }
}
