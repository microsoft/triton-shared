...
class TritonToLinalgLegacyPass
    : public TritonToLinalgLegacyBase<TritonToLinalgLegacyPass> {
...
public:
  ...
  void runOnOperation() override {
...

    {
      ...
      populateTritonToLinalgLegacyCanonicalizationPatterns(patterns);
    ...
    triton::populateTritonToLinalgLegacyConversionPatterns(
...
triton::createTritonToLinalgLegacyPass() {
  return std::make_unique<TritonToLinalgLegacyPass>();
}
