module {
  tt.func public @nested1(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) attributes {noinline = false} {
    ...
    %32:10 = scf.for %arg8 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg9 = %13, %arg10 = %c0, %arg11 = %c0_0, %arg12 = %11, %arg13 = %12, %arg14 = %26, %arg15 = %c0_1, %arg16 = %c0_2, %arg17 = %18, %arg18 = %25) -> (tensor<2x2x!tt.ptr<f32>>, index, index, index, index, tensor<2x2x!tt.ptr<f32>>, index, index, index, index)  : i32 {
      %33 = tts.make_tptr %arg1 to sizes: [2, 2], strides: [%arg17, %arg18], offsets: [%arg15, %arg16], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
      %34 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg12, %arg13], offsets: [%arg10, %arg11], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
      ...
      %36 = arith.addi %arg10, %30 : index
      %37 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg12, %arg13], offsets: [%36, %arg11], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
      ...
      %41 = tt.addptr %arg14, %31 : tensor<2x2x!tt.ptr<f32>>, tensor<2x2xi32>
      scf.yield %37, %36, %arg11, %arg12, %arg13, %40, %39, %arg16, %arg17, %arg18 : tensor<2x2x!tt.ptr<f32>>, index, index, index, index, tensor<2x2x!tt.ptr<f32>>, index, index, index, index
    }
    tt.return
  }
}
