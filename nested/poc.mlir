module {
  tt.func public @nested1(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) attributes {noinline = false} {
    ...
    // ptr1
    %state = tts.make_ptr_state %10 : tuple<2x2x!tt.ptr<f32>>, tuple<offset>, tuple<strides>>
    %ptr = unrealized_cast %state : tensor<2x2x!tt.ptr<f32>>
    %11 = tt.addptr %10, %9 : tensor<2x2x!tt.ptr<f32>>, tensor<2x2xi32>

    %state = tts.make_ptr_state %11 : tuple<2x2x!tt.ptr<f32>>, tuple<offset>, tuple<strides>>
    %ptr = unrealized_cast %state : tensor<2x2x!tt.ptr<f32>>
