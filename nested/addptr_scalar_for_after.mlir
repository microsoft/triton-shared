module {
  tt.func @kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: i32, %arg3: i32, %arg4: i32) {
    ...
    %3:2 = scf.for %arg5 = %c0 to %c12 step %c3 iter_args(%arg6 = %2, %arg7 = %cst) -> (index, tensor<1024xf32>) {
      %7 = tts.make_tptr %arg1 to sizes: [1024], strides: [1], offsets: [%arg6], shape: [0], order: [] : <f32> to tensor<1024x!tt.ptr<f32>>
      ...
      %10 = arith.addf %arg7, %9 : tensor<1024xf32>
      %11 = arith.addi %arg6, %arg5 : index
      scf.yield %11, %10 : index, tensor<1024xf32>
    }
    ...
    "tts.store"(%6, %3#1) <{static_mask_dims = array<i64>}> : (tensor<1024x!tt.ptr<f32>>, tensor<1024xf32>) -> ()
    tt.return
  }
}
