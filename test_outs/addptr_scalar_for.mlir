module {
  tt.func @kernel(%arg0: !tt.ptr<f32, 1> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32, 1> {tt.divisibility = 16 : i32}, %arg2: i32, %arg3: i32, %arg4: i32) {
    ...
    %3:2 = scf.for %arg5 = %c0 to %c12 step %c3 iter_args(%arg6 = %cst, %arg7 = %2) -> (tensor<1024xf32>, index) {
      %7 = tts.make_tptr %arg1 to sizes: [1024], strides: [1], offsets: [%arg7], shape: [0], order: [] : <f32, 1> to tensor<1024x!tt.ptr<f32, 1>>
      %8 = "tts.load"(%7) <{operandSegmentSizes = array<i32: 1, 0, 0>, static_dims = array<i64>}> : (tensor<1024x!tt.ptr<f32, 1>>) -> tensor<1024xf32>
    ...
    %6 = tts.make_tptr %arg0 to sizes: [1024], strides: [1], offsets: [%5], shape: [0], order: [] : <f32, 1> to tensor<1024x!tt.ptr<f32, 1>>
    "tts.store"(%6, %3#0) <{static_dims = array<i64>}> : (tensor<1024x!tt.ptr<f32, 1>>, tensor<1024xf32>) -> ()
    tt.return
  }
}
