module {
  func.func @nested2_complex_body(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) {
    ...
    %9:10 = scf.for %arg10 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg11 = %2, %arg12 = %c0, %arg13 = %c0, %arg14 = %0, %arg15 = %1, %arg16 = %5, %arg17 = %c0, %arg18 = %c0, %arg19 = %3, %arg20 = %4) -> (tensor<2x2x!tt.ptr<f32>>, index, index, index, index, tensor<2x2x!tt.ptr<f32>>, index, index, index, index)  : i32 {
      ...
      %11 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg14, %arg15], offsets: [%10, %arg13], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
      %12 = arith.addi %arg17, %c1 : index
      %13 = tts.make_tptr %arg1 to sizes: [2, 2], strides: [%arg19, %arg20], offsets: [%12, %arg18], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
      %14:10 = scf.for %arg21 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg22 = %11, %arg23 = %10, %arg24 = %arg13, %arg25 = %arg14, %arg26 = %arg15, %arg27 = %13, %arg28 = %12, %arg29 = %arg18, %arg30 = %arg19, %arg31 = %arg20) -> (tensor<2x2x!tt.ptr<f32>>, index, index, index, index, tensor<2x2x!tt.ptr<f32>>, index, index, index, index)  : i32 {
        %21 = tts.make_tptr %arg1 to sizes: [2, 2], strides: [%arg30, %arg31], offsets: [%arg28, %arg29], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
        %22 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg25, %arg26], offsets: [%arg23, %arg24], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
        ...
        %25 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg25, %arg26], offsets: [%24, %arg24], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
        %26 = arith.addi %arg28, %c3 : index
        %27 = tts.make_tptr %arg1 to sizes: [2, 2], strides: [%arg30, %arg31], offsets: [%26, %arg29], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
      ...
      %17 = tts.make_tptr %arg0 to sizes: [2, 2], strides: [%arg14, %arg15], offsets: [%16, %arg13], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
      %18 = arith.addi %arg17, %7 : index
      %19 = arith.addi %18, %c1 : index
      %20 = tts.make_tptr %arg1 to sizes: [2, 2], strides: [%arg19, %arg20], offsets: [%19, %arg18], shape: [0, 0], order: [] : !tt.ptr<f32> to tensor<2x2x!tt.ptr<f32>>
