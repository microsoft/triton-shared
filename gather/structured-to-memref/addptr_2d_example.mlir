...
module {
  func.func @kernel(%arg0: !tt.ptr<bf16>, %arg1: !tt.ptr<bf16>, %arg2: !tt.ptr<bf16>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) {
    ...
    %4 = tts.make_tptr %arg1 to sizes: [4, 256], strides: [1, %c5], offsets: [%3, 0], shape: [0, 0], order: [] : <bf16> to tensor<4x256x!tt.ptr<bf16>>
    ...
    %8 = tts.make_tptr %arg2 to sizes: [4, 256], strides: [1, %c5], offsets: [%7, 0], shape: [0, 0], order: [] : <bf16> to tensor<4x256x!tt.ptr<bf16>>
