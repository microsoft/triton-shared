module {
  func.func @num_programs(%arg0: !tt.ptr<i32>, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32) {
    ...
    %0 = tts.make_tptr %arg0 to sizes: [1], strides: [0], offsets: [%c0], shape: [0], order: [] : !tt.ptr<i32> to tensor<1x!tt.ptr<i32>>
    ...
    %3 = tts.make_tptr %arg0 to sizes: [1], strides: [0], offsets: [%c1], shape: [0], order: [] : !tt.ptr<i32> to tensor<1x!tt.ptr<i32>>
    ...
    %6 = tts.make_tptr %arg0 to sizes: [1], strides: [0], offsets: [%c2], shape: [0], order: [] : !tt.ptr<i32> to tensor<1x!tt.ptr<i32>>
