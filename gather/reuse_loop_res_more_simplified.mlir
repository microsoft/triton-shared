  tt.func public @nested_use_same_level_loop_result(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: i32, %arg3: i32) attributes {noinline = false} {
    ...
    %21 = tt.splat %20 : i32 -> tensor<2x2xi32>
      ...
      %23 = scf.for %arg7 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg8 = %11) -> (tensor<2x2x!tt.ptr<f32>>)  : i32 {
    ...
    //   }
      %25 = tt.addptr %23, %21 : tensor<2x2x!tt.ptr<f32>>, tensor<2x2xi32>
    //   scf.yield %25, %23 : tensor<2x2x!tt.ptr<f32>>, tensor<2x2x!tt.ptr<f32>>
    // }
    tt.return
  }
