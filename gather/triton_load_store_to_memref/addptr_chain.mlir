module {
  func.func @addptr(%arg0: !tt.ptr<f32>, %arg1: !tt.ptr<f32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    scf.for %arg8 = %c0_i32 to %c10_i32 step %c2_i32  : i32 {
      ...
      %6 = "tts.make_unstructured_tptr"(%arg0, %1) : (!tt.ptr<f32>, i64) -> !tt.ptr<f32>
      %7 = tt.load %6 : !tt.ptr<f32>
      %8 = "tts.make_unstructured_tptr"(%arg0, %2) : (!tt.ptr<f32>, i64) -> !tt.ptr<f32>
      %9 = tt.load %8 : !tt.ptr<f32>
      %10 = "tts.make_unstructured_tptr"(%arg1, %4) : (!tt.ptr<f32>, i64) -> !tt.ptr<f32>
      tt.store %10, %7 : !tt.ptr<f32>
      %11 = "tts.make_unstructured_tptr"(%arg1, %5) : (!tt.ptr<f32>, i64) -> !tt.ptr<f32>
