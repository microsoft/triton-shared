...
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: memref<*xbf16>, %arg2: memref<*xi32>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    bufferization.materialize_in_destination %4 in writable %reinterpret_cast : (tensor<256x128xbf16>, memref<256x128xbf16, strided<[1, ?], offset: 6656>>) -> ()
    %reinterpret_cast_0 = memref.reinterpret_cast %arg2 to offset: [6656], sizes: [256, 128], strides: [1, %c6] : memref<*xi32> to memref<256x128xi32, strided<[1, ?], offset: 6656>>
    bufferization.materialize_in_destination %3 in writable %reinterpret_cast_0 : (tensor<256x128xi32>, memref<256x128xi32, strided<[1, ?], offset: 6656>>) -> ()
    return
  }
}
