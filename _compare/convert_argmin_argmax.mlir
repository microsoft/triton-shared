...
module {
  func.func @argmax_012(%arg0: memref<*xf32>, %arg1: memref<*xi32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    %1 = tensor.empty() : tensor<4096xi32>
    %2 = linalg.generic {indexing_maps = [#map], iterator_types = ["parallel"]} outs(%1 : tensor<4096xi32>) {
    ^bb0(%out: i32):
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%3], sizes: [4096], strides: [1] : memref<*xf32> to memref<4096xf32, strided<[1], offset: ?>>
    ...
    %reduced:2 = linalg.reduce ins(%4, %2 : tensor<4096xf32>, tensor<4096xi32>) outs(%6, %8 : tensor<f32>, tensor<i32>) dimensions = [0] 
      (%in: f32, %in_1: i32, %init: f32, %init_2: i32) {
        %10 = arith.cmpf oeq, %in, %init : f32
        %11 = arith.cmpi slt, %in_1, %init_2 : i32
        %12 = arith.andi %10, %11 : i1
        %13 = arith.cmpf ogt, %in, %init : f32
        %14 = arith.ori %13, %12 : i1
        %15 = arith.select %14, %in, %init : f32
        %16 = arith.select %14, %in_1, %init_2 : i32
        linalg.yield %15, %16 : f32, i32
      }
    %extracted = tensor.extract %reduced#1[] : tensor<i32>
    %9 = arith.index_cast %arg6 : i32 to index
    %reinterpret_cast_0 = memref.reinterpret_cast %arg1 to offset: [%9], sizes: [1], strides: [1] : memref<*xi32> to memref<1xi32, strided<[1], offset: ?>>
    affine.store %extracted, %reinterpret_cast_0[0] : memref<1xi32, strided<[1], offset: ?>>
    return
  }
}
