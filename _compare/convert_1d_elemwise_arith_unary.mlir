...
module {
  func.func @kernel(%arg0: memref<*xf32>, %arg1: memref<*xi32>, %arg2: memref<*xf16>, %arg3: memref<1024xbf16>, %arg4: memref<1024xf32>, %arg5: memref<1024xf32>, %arg6: memref<1024xf32>, %arg7: memref<1024xf32>, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32) {
    ...
    bufferization.materialize_in_destination %4 in writable %arg3 : (tensor<1024xbf16>, memref<1024xbf16>) -> ()
    bufferization.materialize_in_destination %5 in writable %arg4 : (tensor<1024xf32>, memref<1024xf32>) -> ()
    bufferization.materialize_in_destination %7 in writable %arg5 : (tensor<1024xf32>, memref<1024xf32>) -> ()
    bufferization.materialize_in_destination %9 in writable %arg6 : (tensor<1024xf32>, memref<1024xf32>) -> ()
    bufferization.materialize_in_destination %10 in writable %arg7 : (tensor<1024xf32>, memref<1024xf32>) -> ()
    return
  }
}
