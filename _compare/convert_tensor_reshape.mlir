...
module {
  func.func @bcast_kernel_01(%arg0: memref<*xf32>, %arg1: memref<*xf32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %2 = bufferization.to_tensor %alloc restrict writable : memref<32xf32>
    %reshape = tensor.reshape %2(%cst) : (tensor<32xf32>, tensor<2xi64>) -> tensor<1x32xf32>
    %3 = tensor.empty() : tensor<64x32xf32>
    %4 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel"]} ins(%reshape : tensor<1x32xf32>) outs(%3 : tensor<64x32xf32>) attrs =  {broadcastDims = array<i64: 0>} {
    ^bb0(%in: f32, %out: f32):
      linalg.yield %in : f32
    } -> tensor<64x32xf32>
    %5 = tensor.empty() : tensor<1xi64>
    %6 = linalg.fill ins(%c2048_i64 : i64) outs(%5 : tensor<1xi64>) -> tensor<1xi64>
    %reshape_0 = tensor.reshape %4(%6) : (tensor<64x32xf32>, tensor<1xi64>) -> tensor<2048xf32>
    %7 = arith.index_cast %0 : i32 to index
    %reinterpret_cast_1 = memref.reinterpret_cast %arg1 to offset: [%7], sizes: [2048], strides: [1] : memref<*xf32> to memref<2048xf32, strided<[1], offset: ?>>
