module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: memref<*xbf16>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %reinterpret_cast_0 = memref.reinterpret_cast %arg0 to offset: [0], sizes: [128], strides: [1] : memref<*xbf16> to memref<128xbf16, strided<[1]>>
    %alloc = memref.alloc() : memref<128xbf16>
    memref.copy %reinterpret_cast_0, %alloc : memref<128xbf16, strided<[1]>> to memref<128xbf16>
    ...
    affine.store %2, %reinterpret_cast[0] : memref<1xbf16>
    return
  }
}
