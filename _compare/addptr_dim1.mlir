...
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %4:3 = scf.for %arg8 = %c0 to %c12 step %c3 iter_args(%arg9 = %1, %arg10 = %c0, %arg11 = %c0) -> (tensor<4x256xbf16>, index, index) {
      %5 = arith.index_cast %arg8 : index to i32
      %6 = arith.muli %5, %c256_i32 : i32
      %7 = arith.index_cast %6 : i32 to index
      %8 = arith.addi %arg10, %arg11 : index
      %reinterpret_cast_2 = memref.reinterpret_cast %arg0 to offset: [%8], sizes: [4, 256], strides: [%7, %c1] : memref<*xbf16> to memref<4x256xbf16, strided<[?, ?], offset: ?>>
      ...
      %9 = bufferization.to_tensor %alloc_3 restrict writable : memref<4x256xbf16>
      %10 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%arg9, %9 : tensor<4x256xbf16>, tensor<4x256xbf16>) outs(%arg9 : tensor<4x256xbf16>) {
      ^bb0(%in: bf16, %in_4: bf16, %out: bf16):
        %13 = arith.addf %in, %in_4 : bf16
        linalg.yield %13 : bf16
      } -> tensor<4x256xbf16>
      %11 = arith.addi %arg10, %c256 : index
      %12 = arith.addi %11, %arg11 : index
      scf.yield %10, %12, %c0 : tensor<4x256xbf16>, index, index
    }
