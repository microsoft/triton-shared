...
module {
  func.func @reduce_kernel_2d_0d(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32) {
    ...
    %1 = scf.for %arg7 = %c0_i32 to %c8_i32 step %c1_i32 iter_args(%arg8 = %reinterpret_cast_0) -> (memref<1xf32, strided<[1], offset: ?>>)  : i32 {
      %2 = scf.for %arg9 = %c0_i32 to %c2_i32 step %c1_i32 iter_args(%arg10 = %arg8) -> (memref<1xf32, strided<[1], offset: ?>>)  : i32 {
        %3 = arith.muli %arg7, %arg9 : i32
        %4 = arith.sitofp %3 : i32 to f32
        affine.store %4, %arg10[0] : memref<1xf32, strided<[1], offset: ?>>
        ...
        %5 = arith.addi %offset_2, %c1 : index
        %reinterpret_cast_5 = memref.reinterpret_cast %base_buffer_1 to offset: [%5], sizes: [1], strides: [1] : memref<f32> to memref<1xf32, strided<[1], offset: ?>>
        scf.yield %reinterpret_cast_5 : memref<1xf32, strided<[1], offset: ?>>
      }
      scf.yield %2 : memref<1xf32, strided<[1], offset: ?>>
    }
    return
  }
}
