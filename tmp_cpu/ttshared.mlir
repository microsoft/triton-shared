module {
  func.func @triton__0d1d2de(%arg0: memref<*xi32> {tt.divisibility = 16 : i32}, %arg1: memref<*xi32> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.divisibility = 16 : i32, tt.max_divisibility = 8 : i32}, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    memref.tensor_store %3, %reinterpret_cast_1 : memref<4x64xi32, strided<[1, ?]>>
    return
  }
}
