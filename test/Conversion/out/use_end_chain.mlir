...
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: memref<*xbf16>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    ^bb0(%in: i32, %in_1: i32, %out: i32):
      %16 = arith.addi %in, %in_1 : i32
      linalg.yield %16 : i32
    } -> tensor<256x128xi32>
    %c512 = arith.constant 512 : index
    %12 = arith.addi %c512, %c6144 : index
    %reinterpret_cast = memref.reinterpret_cast %arg1 to offset: [%12], sizes: [256, 128], strides: [1, %c6] : memref<*xbf16> to memref<256x128xbf16, strided<[1, ?], offset: 512>>
    ...
    %13 = bufferization.to_tensor %alloc restrict writable : memref<256x128xbf16>
    bufferization.materialize_in_destination %13 in writable %reinterpret_cast : (tensor<256x128xbf16>, memref<256x128xbf16, strided<[1, ?], offset: 512>>) -> ()
    %14 = tensor.empty() : tensor<256x128xbf16>
    %15 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = ["parallel", "parallel"]} ins(%11 : tensor<256x128xi32>) outs(%14 : tensor<256x128xbf16>) {
    ^bb0(%in: i32, %out: bf16):
      %16 = arith.sitofp %in : i32 to bf16
      linalg.yield %16 : bf16
    } -> tensor<256x128xbf16>
    bufferization.materialize_in_destination %15 in writable %reinterpret_cast : (tensor<256x128xbf16>, memref<256x128xbf16, strided<[1, ?], offset: 512>>) -> ()
    return
  }
}
