...
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: memref<*xbf16>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg1 to offset: [%c6656], sizes: [256, 128], strides: [1, %c6] : memref<*xbf16> to memref<256x128xbf16, strided<[1, ?], offset: 512>>
    ...
    bufferization.materialize_in_destination %12 in writable %reinterpret_cast : (tensor<256x128xbf16>, memref<256x128xbf16, strided<[1, ?], offset: 512>>) -> ()
    ...
    bufferization.materialize_in_destination %14 in writable %reinterpret_cast : (tensor<256x128xbf16>, memref<256x128xbf16, strided<[1, ?], offset: 512>>) -> ()
    return
  }
}
