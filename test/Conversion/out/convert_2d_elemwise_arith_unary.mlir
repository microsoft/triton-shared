...
module {
  func.func @kernel(%arg0: memref<*xf32>, %arg1: memref<*xi32>, %arg2: memref<*xf16>, %arg3: tensor<128x128x!tt.ptr<bf16, 1>>, %arg4: tensor<128x128x!tt.ptr<f32, 1>>, %arg5: tensor<128x128x!tt.ptr<f32, 1>>, %arg6: tensor<128x128x!tt.ptr<f32, 1>>, %arg7: tensor<128x128x!tt.ptr<f32, 1>>, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32) {
    ...
    tt.store %arg3, %4 {cache = 1 : i32, evict = 1 : i32} : tensor<128x128xbf16>
    tt.store %arg4, %5 {cache = 1 : i32, evict = 1 : i32} : tensor<128x128xf32>
    tt.store %arg5, %7 {cache = 1 : i32, evict = 1 : i32} : tensor<128x128xf32>
