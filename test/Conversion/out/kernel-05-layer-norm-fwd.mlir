...
module {
  func.func @_layer_norm_fwd_fused_0123456789(%arg0: memref<*xf32>, %arg1: memref<*xf32>, %arg2: memref<*xf32>, %arg3: memref<*xf32>, %arg4: memref<*xf32>, %arg5: memref<*xf32>, %arg6: i32, %arg7: i32, %arg8: f32, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32) {
    ...
    %5 = scf.for %arg15 = %c0_i32 to %arg7 step %c256_i32 iter_args(%arg16 = %1) -> (tensor<256xf32>)  : i32 {
      ...
      %reinterpret_cast_5 = memref.reinterpret_cast %arg0 to offset: [%28], sizes: [256], strides: [1] : memref<*xf32> to memref<256xf32, strided<[1], offset: ?>>
      ...
      %subview = memref.subview %reinterpret_cast_5[0] [%33] [1] : memref<256xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
      %subview_6 = memref.subview %alloc[0] [%33] [1] : memref<256xf32> to memref<?xf32, strided<[1]>>
    ...
    %15 = scf.for %arg15 = %c0_i32 to %arg7 step %c256_i32 iter_args(%arg16 = %1) -> (tensor<256xf32>)  : i32 {
      ...
      ^bb0(%in: i32, %in_7: i32, %out: i1):
        %45 = arith.cmpi slt, %in, %in_7 : i32
        linalg.yield %45 : i1
      } -> tensor<256xi1>
      %32 = arith.index_cast %arg15 : i32 to index
      %33 = arith.addi %3, %32 : index
      %reinterpret_cast_5 = memref.reinterpret_cast %arg0 to offset: [%33], sizes: [256], strides: [1] : memref<*xf32> to memref<256xf32, strided<[1], offset: ?>>
      ...
      %subview = memref.subview %reinterpret_cast_5[0] [%38] [1] : memref<256xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
      %subview_6 = memref.subview %alloc[0] [%38] [1] : memref<256xf32> to memref<?xf32, strided<[1]>>
      memref.copy %subview, %subview_6 : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1]>>
      ...
      ^bb0(%in: i1, %in_7: f32, %in_8: f32, %out: f32):
        %45 = arith.select %in, %in_7, %in_8 : f32
        linalg.yield %45 : f32
      } -> tensor<256xf32>
      ...
      ^bb0(%in: f32, %in_7: f32, %out: f32):
        %45 = arith.addf %in, %in_7 : f32
        linalg.yield %45 : f32
      } -> tensor<256xf32>
      scf.yield %44 : tensor<256xf32>
    }
    %16 = bufferization.alloc_tensor() : tensor<f32>
    %inserted_1 = tensor.insert %cst_0 into %16[] : tensor<f32>
    %reduced_2 = linalg.reduce ins(%15 : tensor<256xf32>) outs(%inserted_1 : tensor<f32>) dimensions = [0] 
      (%in: f32, %init: f32) {
        %27 = arith.addf %in, %init : f32
        linalg.yield %27 : f32
      }
    %extracted_3 = tensor.extract %reduced_2[] : tensor<f32>
    %17 = arith.divf %extracted_3, %7 : f32
    %18 = arith.addf %17, %arg8 : f32
    %19 = math.sqrt %18 : f32
    %20 = arith.divf %cst, %19 : f32
    %21 = arith.index_cast %arg12 : i32 to index
    %reinterpret_cast = memref.reinterpret_cast %arg4 to offset: [%21], sizes: [1], strides: [1] : memref<*xf32> to memref<1xf32, strided<[1], offset: ?>>
    affine.store %8, %reinterpret_cast[0] : memref<1xf32, strided<[1], offset: ?>>
    %22 = arith.index_cast %arg12 : i32 to index
    %reinterpret_cast_4 = memref.reinterpret_cast %arg5 to offset: [%22], sizes: [1], strides: [1] : memref<*xf32> to memref<1xf32, strided<[1], offset: ?>>
    affine.store %20, %reinterpret_cast_4[0] : memref<1xf32, strided<[1], offset: ?>>
    ...
    scf.for %arg15 = %c0_i32 to %arg7 step %c256_i32  : i32 {
      %27 = arith.index_cast %arg15 : i32 to index
      %reinterpret_cast_5 = memref.reinterpret_cast %arg2 to offset: [%27], sizes: [256], strides: [1] : memref<*xf32> to memref<256xf32, strided<[1], offset: ?>>
      ...
      %34 = arith.index_cast %arg15 : i32 to index
      %reinterpret_cast_7 = memref.reinterpret_cast %arg3 to offset: [%34], sizes: [256], strides: [1] : memref<*xf32> to memref<256xf32, strided<[1], offset: ?>>
      ...
      %subview_9 = memref.subview %reinterpret_cast_7[0] [%39] [1] : memref<256xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
      %subview_10 = memref.subview %alloc_8[0] [%39] [1] : memref<256xf32> to memref<?xf32, strided<[1]>>
      memref.copy %subview_9, %subview_10 : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1]>>
      %40 = bufferization.to_tensor %alloc_8 restrict writable : memref<256xf32>
      %41 = arith.index_cast %arg15 : i32 to index
      %42 = arith.addi %3, %41 : index
      %reinterpret_cast_11 = memref.reinterpret_cast %arg0 to offset: [%42], sizes: [256], strides: [1] : memref<*xf32> to memref<256xf32, strided<[1], offset: ?>>
      ...
      %subview_13 = memref.subview %reinterpret_cast_11[0] [%47] [1] : memref<256xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
      %subview_14 = memref.subview %alloc_12[0] [%47] [1] : memref<256xf32> to memref<?xf32, strided<[1]>>
      memref.copy %subview_13, %subview_14 : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1]>>
      %49 = bufferization.to_tensor %alloc_12 restrict writable : memref<256xf32>
