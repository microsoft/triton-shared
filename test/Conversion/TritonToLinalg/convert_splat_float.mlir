...
// CHECK:           bufferization.materialize_in_destination %[[VAL_8]] in writable %[[VAL_2]] : (tensor<1024xf32>, memref<1024xf32>) -> ()
// CHECK:           bufferization.materialize_in_destination %[[VAL_10]] in writable %[[VAL_3]] : (tensor<128x256xbf16>, memref<128x256xbf16>) -> ()
// CHECK:           return
// CHECK:         }
