...
// CHECK:           } -> tensor<1024xf32>
// CHECK:           bufferization.materialize_in_destination %[[VAL_43:.*]] in writable %[[VAL_3]] : (tensor<1024xbf16>, memref<1024xbf16>) -> ()
// CHECK:           bufferization.materialize_in_destination %[[VAL_44:.*]] in writable %[[VAL_4]] : (tensor<1024xf32>, memref<1024xf32>) -> ()
// CHECK:           bufferization.materialize_in_destination %[[VAL_45:.*]] in writable %[[VAL_5]] : (tensor<1024xf32>, memref<1024xf32>) -> ()
// CHECK:           bufferization.materialize_in_destination %[[VAL_46:.*]] in writable %[[VAL_6]] : (tensor<1024xf32>, memref<1024xf32>) -> ()
// CHECK:           bufferization.materialize_in_destination %[[VAL_47:.*]] in writable %[[VAL_7]] : (tensor<1024xf32>, memref<1024xf32>) -> ()
// CHECK:           return
// CHECK:         }
