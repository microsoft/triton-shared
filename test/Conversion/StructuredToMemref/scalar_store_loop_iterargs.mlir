...
// CHECK:           [[VAR_3_:%.+]]:2 = scf.for [[VAR_arg10_:%.+]] = [[CST_0_]] to [[CST_5_]] step [[CST_1_]] iter_args([[VAR_arg11_:%.+]] = [[VAR_reinterpret_cast_0_]], [[VAR_arg12_:%.+]] = [[VAR_0_]]) -> (memref<1xf32, strided<[1], offset: ?>>, index)  : i32 {
// CHECK:             affine.store [[VAR_2_]], [[VAR_arg11_]][0] : memref<1xf32, strided<[1], offset: ?>>
// CHECK:             [[VAR_4_:%.+]] = arith.index_cast [[VAR_arg10_]] : i32 to index
...
// CHECK:             [[VAR_5_:%.+]] = arith.addi [[offset_2_]], [[VAR_4_]] : index
// CHECK-DAG:         [[VAR_reinterpret_cast_5_:%.+]] = memref.reinterpret_cast [[base_buffer_1_]] to offset: {{.}}[[VAR_5_]]{{.}}, sizes: [1], strides: [1] : memref<f32> to memref<1xf32, strided<[1], offset: ?>>
// CHECK-DAG:         [[VAR_6_:%.+]] = arith.index_cast [[VAR_arg10_]] : i32 to index
// CHECK:             [[VAR_7_:%.+]] = arith.addi [[VAR_arg12_]], [[VAR_6_]] : index
// CHECK:             scf.yield [[VAR_reinterpret_cast_5_]], [[VAR_7_]] : memref<1xf32, strided<[1], offset: ?>>, index
// CHECK:           }
// CHECK:           return
// CHECK:         }
