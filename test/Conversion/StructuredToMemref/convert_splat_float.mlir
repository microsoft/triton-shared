...
// CHECK-DAG:       [[VAR_empty_offsets_2d_:%.+]] = tensor.empty() : tensor<32768xi32>
// CHECK-DAG:       [[VAR_zero_offsets_2d_:%.+]] = linalg.fill ins([[CST_0_]] : i32) outs([[VAR_empty_offsets_2d_]] : tensor<32768xi32>) -> tensor<32768xi32>
