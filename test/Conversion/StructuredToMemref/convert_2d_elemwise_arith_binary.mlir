...
// CHECK:           } -> tensor<128x128xf32>
// CHECK:           tt.store [[PARAM_2_]], [[VAR_2_]] {cache = 1 : i32, evict = 1 : i32} : tensor<128x128x!tt.ptr<f32>>
// CHECK:           tt.store [[PARAM_3_]], [[VAR_3_]] {cache = 1 : i32, evict = 1 : i32} : tensor<128x128x!tt.ptr<f32>>
// CHECK:           return
// CHECK:         }
