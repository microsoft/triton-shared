...
// CHECK:           } -> tensor<128x128xf32>
// CHECK:           [[FLAT0:%.+]] = tensor.collapse_shape [[VAR_2_]] {{.*}}0, 1{{.*}} : tensor<128x128xf32> into tensor<16384xf32>
...
// CHECK:             linalg.yield
// CHECK:           }
// CHECK:           [[FLAT1:%.+]] = tensor.collapse_shape [[VAR_3_]] {{.*}}0, 1{{.*}} : tensor<128x128xf32> into tensor<16384xf32> 
