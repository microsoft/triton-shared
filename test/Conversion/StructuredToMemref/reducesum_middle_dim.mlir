...
// CHECK-DAG:       [[VAR_empty_offsets_:%.+]] = tensor.empty() : tensor<512xi32>
// CHECK-DAG:       [[VAR_zero_offsets_:%.+]] = linalg.fill ins([[CST_0_]] : i32) outs([[VAR_empty_offsets_]] : tensor<512xi32>) -> tensor<512xi32>
...
// CHECK:             }
// CHECK:           [[FLAT0:%.+]] = tensor.reshape [[VAR_reduced_]](%cst) : (tensor<32x16xbf16>, tensor<1xindex>) -> tensor<512xbf16>
// CHECK:           [[VAR_cast_:%.+]] = memref.cast [[PARAM_2_]] : memref<*xbf16> to memref<?xbf16>
// CHECK:           linalg.generic {indexing_maps = [[[MAP_0_]], [[MAP_0_]]], iterator_types = ["parallel"]} ins([[VAR_zero_offsets_]], [[FLAT0]] : tensor<512xi32>, tensor<512xbf16>) {
