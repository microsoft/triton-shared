...
// CHECK-DAG:       [[VAR_4_:%.+]]:2 = scf.for [[VAR_arg11_:%.+]] = [[CST_0_]] to [[CST_12_]] step [[CST_3_]] iter_args([[VAR_arg12_:%.+]] = [[VAR_1_]], [[VAR_arg13_:%.+]] = [[VAR_3_]]) -> (tensor<128x128xf32>, index) {
// CHECK-DAG:         [[VAR_8_:%.+]] = arith.addi [[VAR_arg13_]], [[CST_128_]] : index
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK:             } -> tensor<128x128xf32>
// CHECK:             [[VAR_12_:%.+]] = arith.addi [[VAR_arg13_]], [[VAR_arg11_]] : index
// CHECK:             scf.yield [[VAR_11_]], [[VAR_12_]] : tensor<128x128xf32>, index
// CHECK:           }
