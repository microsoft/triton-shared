...
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%c0], sizes: [1, 256], strides: [256, 1] : memref<*xbf16> to memref<1x256xbf16, strided<[256, 1]>>
    ...
    %reinterpret_cast_1 = memref.reinterpret_cast %arg0 to offset: [%c0], sizes: [4, 256], strides: [%c256, 1] : memref<*xbf16> to memref<4x256xbf16, strided<[?, 1]>>
