...
// CHECK-DAG:       [[VAR_3_:%.+]] = arith.index_cast [[PARAM_3_]] : i32 to index
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_reinterpret_cast_:%.+]] = memref.reinterpret_cast [[PARAM_0_]] to offset: {{.}}[[CST_0_]]{{.}}, sizes: [4, 4], strides: {{.}}[[VAR_2_]], [[VAR_3_]]{{.}} : memref<*xf32> to memref<4x4xf32, strided<[?, ?]>>
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc() : memref<4x4xf32>
// CHECK:           memref.copy [[VAR_reinterpret_cast_]], [[RES_]] : memref<4x4xf32, strided<[?, ?]>> to memref<4x4xf32>
// CHECK-DAG:       [[VAR_4_:%.+]] = bufferization.to_tensor [[RES_]] restrict writable : memref<4x4xf32>
// CHECK-DAG:       [[VAR_5_:%.+]] = tensor.empty() : tensor<4x4xi32>
...
// CHECK:           } -> tensor<4x4xi32>
// CHECK:           [[VAR_7_:%.+]] = tensor.empty() : tensor<4xf32>
// CHECK-DAG:       [[VAR_8_:%.+]] = linalg.fill ins([[CST_0_1_]] : f32) outs([[VAR_7_]] : tensor<4xf32>) -> tensor<4xf32>
// CHECK-DAG:       [[VAR_9_:%.+]] = linalg.fill ins([[CST_minus_1_]] : i32) outs([[VAR_0_]] : tensor<4xi32>) -> tensor<4xi32>
// CHECK:           [[VAR_reduced_:%.+]]:2 = linalg.reduce ins([[VAR_4_]], [[VAR_6_]] : tensor<4x4xf32>, tensor<4x4xi32>) outs([[VAR_8_]], [[VAR_9_]] : tensor<4xf32>, tensor<4xi32>) dimensions = [1]
// CHECK:             ([[IN_1_]]: f32, [[in_1_]]: i32, [[init_]]: f32, [[init_2_]]: i32) {
// CHECK-DAG:           [[VAR_11_1_:%.+]] = arith.cmpf oeq, [[IN_1_]], [[init_]] : f32
...
// CHECK:               linalg.yield [[VAR_16_]], [[VAR_17_]] : f32, i32
// CHECK:             }
// CHECK-DAG:       [[VAR_reinterpret_cast_0_:%.+]] = memref.reinterpret_cast [[PARAM_1_]] to offset: {{.}}[[CST_0_]]{{.}}, sizes: [4], strides: [1] : memref<*xf32> to memref<4xf32, strided<[1]>>
// CHECK-DAG:       [[VAR_10_:%.+]] = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel"]} ins([[VAR_reduced_]]#1 : tensor<4xi32>) outs([[VAR_7_]] : tensor<4xf32>) {
// CHECK:           ^bb0([[IN_3_:%.+]]: i32, [[IN_4_:%.+]]: f32):
// CHECK:             [[VAR_11_2_:%.+]] = arith.sitofp [[IN_3_]] : i32 to f32
// CHECK:             linalg.yield [[VAR_11_2_]] : f32
