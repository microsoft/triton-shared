...
module {
  func.func @bitcast_ptr_as_src(%arg0: memref<*xi32>, %arg1: memref<*xi32>, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32) {
    ...
    %2 = builtin.unrealized_conversion_cast %1 : !tt.ptr<i32> to !tt.ptr<i32>
    %3 = builtin.unrealized_conversion_cast %arg0 : memref<*xi32> to !tt.ptr<i32>
    %4 = builtin.unrealized_conversion_cast %3 : !tt.ptr<i32> to !tt.ptr<i32>
    // %5 = arith.muli %c1_i32, %0 : i32
    %6 = tptr.ptradd %4 %c1_i32 : !tt.ptr<i32>, i32 to !tt.ptr<i32>
    %7 = builtin.unrealized_conversion_cast %6 : !tt.ptr<i32> to !tt.ptr<i64>
    ...
    %10 = tptr.ptradd %2 %c1_i32 : !tt.ptr<i32>, i32 to !tt.ptr<i32>
    %11 = builtin.unrealized_conversion_cast %10 : !tt.ptr<i32> to !tt.ptr<i64>
