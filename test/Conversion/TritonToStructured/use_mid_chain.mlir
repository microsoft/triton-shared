...
// CHECK-DAG:       [[VAR_3_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [256, 128], strides: [1, [[CST_6_]]{{.}}, offsets: [512, [[CST_6_]]144], parent_sizes: [0, 0] : <bf16, 1> to tensor<256x128x!tt.ptr<bf16, 1>>
...
// CHECK:           [[VAR_5_:%.+]] = tts.make_tptr [[PARAM_2_]] to sizes: [256, 128], strides: [1, [[CST_6_]]{{.}}, offsets: [512, [[CST_6_]]144], parent_sizes: [0, 0] : <i32, 1> to tensor<256x128x!tt.ptr<i32, 1>>
