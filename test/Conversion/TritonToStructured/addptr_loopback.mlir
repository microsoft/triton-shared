...
// CHECK-DAG:       [[VAR_1_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [4, 256], strides: [1, [[CST_6_]]{{.}}, offsets: {{.}}[[VAR_0_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
// CHECK-DAG:       [[VAR_2_:%.+]] = arith.index_cast [[PARAM_2_]] : i32 to index
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_3_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [4, 256], strides: [1, [[CST_6_]]{{.}}, offsets: {{.}}[[VAR_2_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
