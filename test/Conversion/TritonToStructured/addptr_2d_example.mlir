...
// CHECK:           [[VAR_4_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [4, 256], strides: [1, [[CST_5_]]{{.}}, offsets: {{.}}[[VAR_3_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
...
// CHECK:           [[VAR_8_:%.+]] = tts.make_tptr [[PARAM_2_]] to sizes: [4, 256], strides: [1, [[CST_5_]]{{.}}, offsets: {{.}}[[VAR_7_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
