...
// CHECK:           [[VAR_3_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [1024, 1024], strides: [1, 1], offsets: {{.}}[[VAR_2_]], 0], parent_sizes: [0, 0] : <f32, 1> to tensor<1024x1024x!tt.ptr<f32, 1>>
...
// CHECK:           [[VAR_8_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [1024, 1024], strides: [1, 1], offsets: {{.}}[[VAR_7_]], 0], parent_sizes: [0, 0] : <f32, 1> to tensor<1024x1024x!tt.ptr<f32, 1>>
