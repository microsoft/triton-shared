...
// CHECK-DAG:       [[VAR_4_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [1024], strides: {{.}}[[CST_11_]]{{.}}, offsets: {{.}}[[VAR_3_]]{{.}}, parent_sizes: [0] : <bf16, 1> to tensor<1024x!tt.ptr<bf16, 1>>
// CHECK-DAG:       [[VAR_5_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [1024], strides: [1], offsets: {{.}}[[VAR_1_]]{{.}}, parent_sizes: [0] : <bf16, 1> to tensor<1024x!tt.ptr<bf16, 1>>
