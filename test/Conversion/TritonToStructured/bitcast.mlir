...
// CHECK-DAG:       [[VAR_0_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [1024], strides: [1], offsets: [0], parent_sizes: [0] : <i32, 1> to tensor<1024x!tt.ptr<i32, 1>>
// CHECK-DAG:       [[VAR_1_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [1024], strides: [1], offsets: [0], parent_sizes: [0] : <f32, 1> to tensor<1024x!tt.ptr<f32, 1>>
