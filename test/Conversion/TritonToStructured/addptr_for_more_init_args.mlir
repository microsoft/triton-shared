...
// CHECK-DAG:         [[VAR_1_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [256], strides: {{.}}[[CST_1_]]{{.}}, offsets: {{.}}[[VAR_arg7_]]{{.}}, parent_sizes: [0] : <bf16, 1> to tensor<256x!tt.ptr<bf16, 1>>
// CHECK-DAG:         [[VAR_2_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [256], strides: {{.}}[[CST_1_]]{{.}}, offsets: {{.}}[[VAR_arg6_]]{{.}}, parent_sizes: [0] : <bf16, 1> to tensor<256x!tt.ptr<bf16, 1>>
