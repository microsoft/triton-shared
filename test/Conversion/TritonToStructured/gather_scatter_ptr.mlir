...
// CHECK:           %[[VAL_31:.*]] = tt.splat %[[VAL_30]] : i32 -> tensor<16x1xi32>
// CHECK:           %[[VAL_32:.*]] = arith.muli %[[VAL_28]], %[[VAL_31]] : tensor<16x1xi32>
// CHECK:           %[[VAL_33:.*]] = tt.splat %[[VAL_22]] : i32 -> tensor<16x1xi32>
// CHECK:           %[[VAL_34:.*]] = arith.addi %[[VAL_21]], %[[VAL_33]] : tensor<16x1xi32>
// CHECK:           %[[VAL_35:.*]] = arith.index_cast %[[VAL_8]] : i64 to index
// CHECK:           %[[VAL_36:.*]] = arith.index_cast %[[VAL_35]] : index to i32
// CHECK:           %[[VAL_37:.*]] = tt.splat %[[VAL_36]] : i32 -> tensor<16x1xi32>
// CHECK:           %[[VAL_38:.*]] = arith.muli %[[VAL_34]], %[[VAL_37]] : tensor<16x1xi32>
// CHECK:           %[[VAL_39:.*]] = arith.addi %[[VAL_32]], %[[VAL_38]] : tensor<16x1xi32>
...
// CHECK:           %[[VAL_56:.*]] = arith.index_cast %[[VAL_55]] : index to i32
// CHECK:           %[[VAL_57:.*]] = tt.splat %[[VAL_56]] : i32 -> tensor<16x1xi32>
// CHECK:           %[[VAL_58:.*]] = arith.muli %[[VAL_28]], %[[VAL_57]] : tensor<16x1xi32>
// CHECK:           %[[VAL_59:.*]] = arith.index_cast %[[VAL_11]] : i64 to index
// CHECK:           %[[VAL_60:.*]] = arith.index_cast %[[VAL_59]] : index to i32
// CHECK:           %[[VAL_61:.*]] = tt.splat %[[VAL_60]] : i32 -> tensor<16x1xi32>
// CHECK:           %[[VAL_62:.*]] = arith.muli %[[VAL_34]], %[[VAL_61]] : tensor<16x1xi32>
// CHECK:           %[[VAL_63:.*]] = arith.addi %[[VAL_58]], %[[VAL_62]] : tensor<16x1xi32>
