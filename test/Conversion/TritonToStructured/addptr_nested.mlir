...
// CHECK:           [[VAR_5_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [4, 256], strides: [2, [[CST_10_]]{{.}}, offsets: {{.}}[[VAR_4_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
...
// CHECK:           [[VAR_10_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [4, 256], strides: [3, [[CST_15_]]{{.}}, offsets: {{.}}[[VAR_9_]], 0], parent_sizes: [0, 0] : <bf16, 1> to tensor<4x256x!tt.ptr<bf16, 1>>
