...
// CHECK-DAG:         [[VAR_24_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [256, 256], strides: {{.}}[[VAR_22_]], 1], offsets: {{.}}[[VAR_23_]], [[VAR_5_]]{{.}}, parent_sizes: [0, 0] : <f32, 1> to tensor<256x256x!tt.ptr<f32, 1>>
...
// CHECK-DAG:         [[VAR_42_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [256, 256], strides: {{.}}[[VAR_40_]], 1], offsets: {{.}}[[VAR_41_]], [[VAR_4_]]{{.}}, parent_sizes: [0, 0] : <f32, 1> to tensor<256x256x!tt.ptr<f32, 1>>
...
// CHECK:           }) : (tensor<256x256xf32>) -> tensor<256xf32>
// CHECK-DAG:       [[VAR_9_:%.+]] = tts.make_tptr [[PARAM_2_]] to sizes: [256], strides: [1], offsets: {{.}}[[VAR_3_]]{{.}}, parent_sizes: [0] : <f32, 1> to tensor<256x!tt.ptr<f32, 1>>
...
// CHECK-DAG:       [[VAR_15_:%.+]] = tts.make_tptr [[PARAM_3_]] to sizes: [256], strides: [1], offsets: {{.}}[[VAR_2_]]{{.}}, parent_sizes: [0] : <f32, 1> to tensor<256x!tt.ptr<f32, 1>>
