...
// CHECK:             [[VAR_9_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [128, 128], strides: [1, 1], offsets: {{.}}[[VAR_8_]], 0], parent_sizes: [0, 0] : <f32, 1> to tensor<128x128x!tt.ptr<f32, 1>>
...
// CHECK:           [[VAR_7_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [128, 128], strides: [1, 1], offsets: {{.}}[[VAR_6_]], 0], parent_sizes: [0, 0] : <f32, 1> to tensor<128x128x!tt.ptr<f32, 1>>
