...
// CHECK-DAG:         [[VAR_1_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [256, 256], strides: {{.}}[[CST_2_]], 1], offsets: {{.}}[[VAR_arg2_]], 256], parent_sizes: [0, 0] : <bf16, 1> to tensor<256x256x!tt.ptr<bf16, 1>>
