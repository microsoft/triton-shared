...
// CHECK:           [[VAR_15_:%.+]] = tensor.empty() : tensor<512x!tt.ptr<f32, 1>>
// CHECK:           [[VAR_16_:%.+]] = linalg.fill ins([[PARAM_1_]] : !tt.ptr<f32, 1>) outs([[VAR_15_]] : tensor<512x!tt.ptr<f32, 1>>) -> tensor<512x!tt.ptr<f32, 1>>
// CHECK:           [[VAR_17_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_16_]], [[VAR_3_]] : tensor<512x!tt.ptr<f32, 1>>, tensor<512xi32>) outs([[VAR_16_]] : tensor<512x!tt.ptr<f32, 1>>) {
// CHECK:           ^bb0([[in_]]: !tt.ptr<f32, 1>, [[in_]]_1: i32, [[out_]]: !tt.ptr<f32, 1>):
// CHECK:             [[VAR_22_5_:%.+]] = tt.addptr [[in_]], [[in_]]_1 : !tt.ptr<f32, 1>, i32
// CHECK:             linalg.yield [[VAR_22_5_]] : !tt.ptr<f32, 1>
// CHECK:           } -> tensor<512x!tt.ptr<f32, 1>>
...
// CHECK:             }
// CHECK:           tt.store [[VAR_17_]], [[VAR_reduced_]] {cache = 1 : i32, evict = 1 : i32} : tensor<512x!tt.ptr<f32>>
// CHECK:           return
// CHECK:         }
