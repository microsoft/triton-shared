...
// CHECK:             [[VAR_17_2_:%.+]] = tt.addptr [[in_]], [[in_]]_0 : !tt.ptr<f32, 1>, i32
// CHECK:             linalg.yield [[VAR_17_2_]] : !tt.ptr<f32, 1>
...
// CHECK-DAG:       [[VAR_12_:%.+]] = tensor.empty() : tensor<4096x!tt.ptr<i32, 1>>
// CHECK:           [[VAR_13_:%.+]] = linalg.fill ins([[PARAM_1_]] : !tt.ptr<i32, 1>) outs([[VAR_12_]] : tensor<4096x!tt.ptr<i32, 1>>) -> tensor<4096x!tt.ptr<i32, 1>>
// CHECK:           [[VAR_14_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_13_]], [[VAR_5_]] : tensor<4096x!tt.ptr<i32, 1>>, tensor<4096xi32>) outs([[VAR_13_]] : tensor<4096x!tt.ptr<i32, 1>>) {
// CHECK:           ^bb0([[in_]]: !tt.ptr<i32, 1>, [[in_]]_0: i32, [[out_]]: !tt.ptr<i32, 1>):
// CHECK:             [[VAR_17_3_:%.+]] = tt.addptr [[in_]], [[in_]]_0 : !tt.ptr<i32, 1>, i32
// CHECK:             linalg.yield [[VAR_17_3_]] : !tt.ptr<i32, 1>
// CHECK:           } -> tensor<4096x!tt.ptr<i32, 1>>
...
// CHECK:           } -> tensor<4096xi32>
// CHECK:           tt.store [[VAR_14_]], [[VAR_16_]] {cache = 1 : i32, evict = 1 : i32} : tensor<4096x!tt.ptr<i32>>
// CHECK:           return
// CHECK:         }
