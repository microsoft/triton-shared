...
// CHECK-DAG:         [[LOAD_VAR_arg22_MEM_:%.+]] = tt.load [[VAR_arg22_]] {boundaryCheck = array<i32: 0, 1>, cache = 1 : i32, evict = 1 : i32, isVolatile = false} : !tt.ptr<tensor<128x64xbf16>, 1> -> tensor<128x64xbf16>
// CHECK-DAG:         [[LOAD_VAR_arg23_MEM_:%.+]] = tt.load [[VAR_arg23_]] {boundaryCheck = array<i32: 0, 1>, cache = 1 : i32, evict = 1 : i32, isVolatile = false} : !tt.ptr<tensor<128x64xbf16>, 1> -> tensor<128x64xbf16>
...
// CHECK:           tt.store [[VAR_13_]], [[VAR_8_]]#0 {boundaryCheck = array<i32: 0, 1>, cache = 1 : i32, evict = 1 : i32} : !tt.ptr<tensor<128x64xbf16>, 1>, tensor<128x64xbf16>
// CHECK:           return
// CHECK:         }
