...
// CHECK:             [[VAR_21_4_:%.+]] = tt.addptr [[in_]], [[in_]]_1 : !tt.ptr<bf16, 1>, i32
// CHECK:             linalg.yield [[VAR_21_4_]] : !tt.ptr<bf16, 1>
// CHECK:           } -> tensor<512x256x!tt.ptr<bf16, 1>>
// CHECK:           [[VAR_15_:%.+]] = tensor.empty() : tensor<256x!tt.ptr<bf16, 1>>
// CHECK:           [[VAR_16_:%.+]] = linalg.fill ins([[PARAM_1_]] : !tt.ptr<bf16, 1>) outs([[VAR_15_]] : tensor<256x!tt.ptr<bf16, 1>>) -> tensor<256x!tt.ptr<bf16, 1>>
// CHECK:           [[VAR_17_:%.+]] = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel"]} ins([[VAR_16_]], [[VAR_8_]] : tensor<256x!tt.ptr<bf16, 1>>, tensor<256xi32>) outs([[VAR_16_]] : tensor<256x!tt.ptr<bf16, 1>>) {
// CHECK:           ^bb0([[in_]]: !tt.ptr<bf16, 1>, [[in_]]_1: i32, [[out_]]: !tt.ptr<bf16, 1>):
